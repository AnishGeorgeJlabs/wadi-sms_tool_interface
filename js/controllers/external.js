...
(function() {
  angular.module('Wadi.controllers.external', []).controller('ExternalDataCtrl', function($scope, wdInterfaceApi, $interval, $http, wdExternalSegment, wdToast) {
    ...
    $scope.createSegments = function() {
      return wdExternalSegment.new_segments($scope.unsegmented_count).then(function(res) {
        if (res) {
